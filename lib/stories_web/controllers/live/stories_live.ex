defmodule StoriesWeb.StoriesLive do
  ...
  def handle_event("generate_story", params, socket) do
    ...
    story_prompt =
      ...
      The tale should feat an unconventional hero named #{hero}.
      ...
      The journey should feature a villain called #{villain}. This villain's backstory needs to be complex and interesting. Describe how #{villain}'s past experiences, especially those connected with #{hero}, led them down the path of villainy.
      ...
      I just want #{kid} to have fun and be entertained, and for #{hero} to beat #{villain}.
      Please wrap story paragraphs in hrml paragraph tags.
      """
